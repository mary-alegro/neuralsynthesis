...
do
echo 'Epoch '$epoch
CMD='--dataroot '$DATA_ROOT' --name '$DB' --model pix2pix --dataset_mode aligned --gpu_id '$GPU' --load_iter '$epoch' --force_test_output '$RESULTSDIR'/'$DB'_'$epoch' --checkpoints_dir '$CPDIR
echo $CMD
